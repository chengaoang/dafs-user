...
export default function animate() {
    ...
    // 晨昏与四季,y从0往上走156
    scene1.fromTo("#info21", {opacity:0,x:200,y:0,fontSize:7,fill:"black" },{opacity:1,y:-156,fontSize:7,fill:"white"}, 3)
    // scene1.fromTo("#info21", { opacity: 0 ,x: 60,fontSize: 5, fill: "black"},{ opacity: 1, y: 0, fontSize: 5, fill: "white" }, 0)
    ...
    // 落俗不可避免，浪漫至死不渝
    scene3.fromTo("#text2", { opacity: 0 ,x: 60,fontSize: 5, fill: "black"}, { opacity: 1, y: -450, fontSize: 5, fill: "white",onComplete:complete }, 0)
    // opacity 不透明度
    function complete() {
        setTimeout(()=>{
